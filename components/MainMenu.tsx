  ...
  return (
    <div className="absolute inset-0 z-50 overflow-hidden flex items-center justify-center font-sans">
      ...
      <div className="absolute inset-0 z-0 overflow-hidden">
        ...
        <div 
          className={`absolute inset-0 bg-gradient-to-br from-gray-900 via-gray-800 to-black transition-opacity duration-500 ${imageLoaded ? 'opacity-0' : 'opacity-100'}`}
        ></div>
